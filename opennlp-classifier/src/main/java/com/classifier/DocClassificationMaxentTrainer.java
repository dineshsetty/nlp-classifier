...
public class DocClassificationMaxentTrainer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            BufferedOutputStream modelOut = new BufferedOutputStream(new FileOutputStream(modelFileDir + "/model" + File.separator+"en-movie-classifier-maxent.bin"));
            model.serialize(modelOut);
            System.out.println("\nTrained Model is saved locally at : "+modelFileDir+"/model"+File.separator+"en-movie-classifier-maxent.bin");
