...
public class DocClassificationNaiveBayesTrainer {
    ...
    public static void main(String[] args) {
        ...
        try {
        	...
        	String trainFileName = "train/en-movie-category.train";        	 
        	ClassLoader classLoader = ClassLoader.getSystemClassLoader();
        	String modelFileDir = "C:\\Dinesh\\OpenNLP\\";
        	InputStreamFactory dataIn = new MarkableFileInputStreamFactory(new File(classLoader.getResource(trainFileName).getFile()));
            ...
            BufferedOutputStream modelOut = new BufferedOutputStream(new FileOutputStream(modelFileDir + "/model" + File.separator+"en-movie-classifier-naive-bayes.bin"));
            model.serialize(modelOut);
            System.out.println("\nTrained Model is saved locally at : "+modelFileDir+"/model"+File.separator+"en-movie-classifier-naive-bayes.bin");
